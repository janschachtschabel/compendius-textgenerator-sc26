...
| `POST /api/v1/linker`, `/api/v1/qa`, `/api/v1/utils/{split,synonyms,translate}` | Alt-Funktionen: Artikel und Synonyme aus den Archiven, Frage-Antwort-Paare mit LLM oder aus Fragevorlagen, Übersetzung nur mit LLM (sonst 503) |
