...
| Tokens je Kompendium | rund 7.900 | 0 im Standard; mit LLM-Schaltern 2.300 bis rund 37.000, mit `matcher=llm` hochgerechnet im Median rund 29.000 mehr (D36), mit `article_choice=llm` rund 1.000 bis 2.000 |
