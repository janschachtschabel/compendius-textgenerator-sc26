...
| Der Text eines Aufrufers wird in linearer Zeit gelesen; ein leerer Baustein ist keine Prosa, ein Kompendium ohne Prosa hat nichts zu fragen (Review von D60) | seit D60 laufen Glossar- und Akteursmuster auf dem Text, den `/qa` ohne Anmeldung annimmt; ein präparierter Text hielt einen Worker Sekunden bis Stunden fest | keiner: die Paare der sechs Themen von M30 bleiben gleich |
