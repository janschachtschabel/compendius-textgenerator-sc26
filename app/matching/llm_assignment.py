...
hybrid_light with Model2Vec on the same 603 paragraphs, at about 240 tokens per paragraph. The model sees what a
...
BATCH_SIZE = 25
TEXT_CHARS = 700  # per paragraph, as in the measurement
